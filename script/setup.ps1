...
$guidPattern = Prompt-UserInput "Enter GUID Pattern" "^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[4][0-9a-fA-F]{3}-[89ab][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$"
...
`$gitLogSeq = "$gitLogSeq"
# export_from_scribe.ps1 variables
